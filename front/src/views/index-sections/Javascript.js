					...
					<Row id="modals">
						<Col md="6">
							...
							<Modal modalClassName="modal-mini modal-info" toggle={() => setModal2(false)} isOpen={modal2}>
								...
								<div className="modal-footer">
									...
									<Button className="btn-neutral" color="link" type="button" onClick={() => setModal2(false)}>
										Close
									</Button>
								</div>
							</Modal>
						...
						<Col md="6">
							...
							<UncontrolledPopover
								...
								<PopoverBody>Here will be some very useful information about his popover.</PopoverBody>
							</UncontrolledPopover>
							...
							<UncontrolledPopover placement={window.innerWidth < 768 ? 'bottom' : 'right'} target="tooltip966745638">
							...
							<Row>
								<Col md="6">
									<div className="datepicker-container">
										<FormGroup>
											<Datetime timeFormat={false} inputProps={{ placeholder: 'Datetime Picker Here' }} />
										</FormGroup>
									</div>
								</Col>
							</Row>
						...
						<Col md="6">
							<h4>Tooltips</h4>
							<Button className="btn-tooltip mr-1" color="default" id="tooltip116884155" type="button">
								On left
							</Button>
							<UncontrolledTooltip delay={0} placement="left" target="tooltip116884155">
								Tooltip on left
							</UncontrolledTooltip>
							<Button className="btn-tooltip mr-1" color="default" id="tooltip502327420" type="button">
								On top
							</Button>
							<UncontrolledTooltip delay={0} placement="top" target="tooltip502327420">
								Tooltip on top
							</UncontrolledTooltip>
							<Button className="btn-tooltip mr-1" color="default" id="tooltip243887155" type="button">
								On bottom
							</Button>
